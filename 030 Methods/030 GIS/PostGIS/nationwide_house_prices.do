...
clear
cd "/Users/gjm06/GIS/Data/Social/House prices/NATIONWIDE"
...
clear
insheet using "/Users/gjm06/GIS/Data/Borders, boundaries, codes/NSPDF_AUG_2010_UK_1M_FP.csv", comma
save "/Users/gjm06/GIS/Data/Borders, boundaries, codes/NSPDF_AUG_2010_UK_1M_FP.dta"
...
save "/Users/gjm06/GIS/Data/Borders, boundaries, codes/lsoa_msoa_dzone_izone.dta"

* Merge

merge m:1 postcode using "/Users/gjm06/GIS/Data/Borders, boundaries, codes/lsoa_msoa_dzone_izone.dta", keep(match master)
...
outreg2 using "/Users/gjm06/Downloads/housepricefe.xls", sideway label alpha(0.001, 0.01, 0.05, 0.1) symbol(***, **, *, +) auto(2) adjr2 word
...
outreg2 using "/Users/gjm06/Downloads/housepriceols.xls", sideway label alpha(0.001, 0.01, 0.05, 0.1) symbol(***, **, *, +) auto(2) adjr2 word

predict house_price_residual, residuals

set scheme s1mono
hist house_price_residual if house_price_residual > -2 && house_price_residual < 2, xtitle("House price regression residuals (ln(£))")

preserve
keep postcode house_price_residual
drop if missing(postcode, house_price_residual)
outsheet using "/Users/George/GIS/Data/Social/House prices/NATIONWIDE/house_price_residuals.csv", comma replace
restore
